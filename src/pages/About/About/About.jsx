            ...
            <div className="others-page-banner flex items-center">
                <Container>
                    <div className="w-full flex flex-col items-center text-white">
                        <h1 className="text-4xl font-semibold mb-2">Lets explore more about us.</h1>
                        <p>We have a story to tell. We have mission and vision, explore this section to know more about us.</p>
                    </div>
                </Container>
            </div>
            {/* Page Content */}
